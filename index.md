...
Here's where you'll put images of your schematics. [Tinkercad](https://www.tinkercad.com/blog/official-guide-to-tinkercad-circuits) and [Fritzing](https://fritzing.org/learning/) are both great resoruces to create professional schematic diagrams, though BSE recommends Tinkercad becuase it can be done easily and for free in the browser. 
  ...
  If you want to add a library manually, you can simply drag and drop a file into it. For example, if you want to add the memorysaver.h file(which you will need for the camera code to work), open the libraries folder, and simply drag and drop the Arducam folder included into the library.
